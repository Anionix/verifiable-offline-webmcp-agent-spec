...
event_uuid_v7: "01a04bb2-b8ef-7383-a4b6-1258dd5c1425"
observed_at: "2026-08-29T04:06:39.087Z"
status: "public-version-4-live-verified"
---
...
| WebMCP四機能の発見と実行 | 成功（現行版） | 一般公開前の版3で発見と実行を確認。版4は同じ四機能を維持し、通常の再送との比較を追加 |
...
| ChatGPT Sites一般公開実行 | 成功（現行版） | [本番URL](https://kyoto-booking-retry-proof.anionix.chatgpt.site)の版4を未ログインで表示。2試行、1予約、処理開始1、同じ確認番号、再読込復元、ブラウザーエラー0件を確認 |
| 可視証拠パネル | 成功（現行版） | 版4でUUIDv5、最新UUIDv7、履歴4件、SHA-256連鎖`Valid`を実画面確認 |
| Vercel更新 | 未計測 | 別承認が必要 |
...
- WebMCP比較画面を含むコミット`a628eb9a91d310393a3b69b1130ab92871054d16`は、ChatGPT Sites版4として一般公開済みです。未ログイン表示、人間確認境界、再送収束、再読込復元を実URLで確認しました。
