...
// machine-contract: the positive boundary covers Vite publicDir, hotel runtime and test source, and build entry configuration. Documentation, metadata, and validation control remain under their own checks.
