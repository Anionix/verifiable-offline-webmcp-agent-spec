...
node --test "$ROOT/scripts/validate_hotel_release.test.mjs"
...
node --test "$ROOT/scripts/test_validate_public_release_alignment.mjs"
...
node --test "$ROOT/scripts/test_build_hotel_release_diagram.mjs"
